    ...
    *get_simple_inputs() {
    ...
    verify_checkbox_inputs() {
        ...
        for (let unique of unique_names) {
            ...
            this.checkboxes = Array.from(this.document.querySelectorAll(`input[type="checkbox"][name=${unique}]`));
            //
    ...
    checkbox_changes(unique) {
        ...
        for (let checkbox of this.checkboxes) {
            ...
            checkbox.onchange = () => {
                //
                //Validate checkbox inputs
                this.validate_checkbox_inputs(checkbox);
                //
    ...
    validate_checkbox_inputs(checkbox) {
        console.log(this.checkboxes);
        //
        ...
        const reports = Array.from(this.document.querySelectorAll(".report"));
        //
        //
    ...
    set_visible(unique) {
        ...
        let dialog_panel = this.document.querySelector(".dialog");
        //
        ...
        show_errors.forEach(show => {
            ...
            show.onclick = async () => {
                ...
                dialog_panel.querySelector(".dialog>.error_message").innerHTML = `Select at least one value for the ${unique} from the ones listed above`;
                //
        ...
        const close_errors = Array.from(dialog_panel.querySelectorAll(".dialog>.header>.close"));
